document.addEventListener('DOMContentLoaded', () => {
    ...
    const apiEndpoint = '/content/api/v1/alarm_prediction'; // Ваш API endpoint

    // Функція для отримання та відображення даних
    const fetchAndDisplayPredictions = async () => {
        predictionDataElement.innerHTML = '<p>Завантаження прогнозу...</p>'; // Показати повідомлення про завантаження
